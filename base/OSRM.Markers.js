...
setVia: function(id, position) {
	...
	this.route.splice(this.route.length,0, new OSRM.RouteMarker(OSRM.C.VIA_LABEL, {draggable:true,icon:OSRM.G.icons['marker-via'],dragicon:OSRM.G.icons['marker-via-drag']}, position));
	return this.route.length-1;
},
